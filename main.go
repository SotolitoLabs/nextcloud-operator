...
import (
	...
	"github.com/SotolitoLabs/nextcloud-operator/controllers"
...
func init() {
	...
	utilruntime.Must(nextcloudoperatorv1alpha1.AddToScheme(scheme))
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "ef408389.sotolitolabs.com",
